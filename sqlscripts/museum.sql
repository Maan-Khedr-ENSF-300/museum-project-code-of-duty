...
INSERT INTO ARTIST (AName, DateBorn, DateDied, Country_origin, Main_style, Descript, Epoch)
VALUES
...
CREATE TABLE ART_OBJECT (
    ...
    D_EName					varchar(70)	 not null,
    C_AName					varchar(60), 
	primary key (Id_no),
    foreign key (D_EName) references EXHIBITION(EName),
	foreign key (C_AName) references ARTIST(AName)
);

INSERT INTO ART_OBJECT (Id_no, Descript, Title, Origin, Yr, Epoch, Style, D_EName, C_AName)
VALUES
...
('1851','This statue represents a candle-bearing angel stepping forward, knees slightly bent, portraying a sense of movement and energy, 
with wavy hair adorned','Angel Bearing Candlestick','Italy','1524','Renaissance','Modern','The Tudors: Art and Majesty in Renaissance England','Benedetto da Rovezzano'),
('3416',"The subject was traditionally identified as John Fisher, Bishop of Rochester and confessor to Henry VIII's first queen, Catherine of Aragon, but the identification 
has been increasingly called into question.",'Portrait Bust of John Fisher','United Kingdom','1510','Renaissance','Modern','The Tudors: Art and Majesty in Renaissance England','Pietro Torrigiano'),
('2934','In the sixteenth century, Chinese porcelain occasionally arrived in England, sometimes by way of the Levant, sometimes by sea around the Cape of Good Hope. 
As it was very rare and considered a special treasure, the most accomplished English silversmiths were often commissioned to make mounts for it. 
Pieces such as these were regarded as suitable for royal gifts or for the furnishing of princely houses.', 'Ewer from Burghley House, Lincolnshire','China','1573','Renaissance','Modern','The Tudors: Art and Majesty in Renaissance England',null),
('1727','Represents the dangers and temptations that beset man and threaten to divert him from an existence predicated upon piety and study, 
including the study of mathematics.', 'Tabula Cebetis, and De Mortis Effectibus','Italy','1507','Renaissance','Modern','The Tudors: Art and Majesty in Renaissance England','Philippus Albericus'),
...
('1388',"Pliny the Elder’s origin story of eye-deceiving illusionism and creative competition, recounted on the wall at right, influenced artists in the Renaissance 
and for centuries after. Still-life painting emerged in the 1600s as a fully independent subject in European art, and grapes and curtains became popular motifs 
for artists aiming to vaunt their skills.", 'Still Life with Four Bunches of Grapes','Spain','1636','Elizabeth','Modern',"Cubism and the Trompe l’Oeil Tradition",'Juan Fernández'),
...
('2684',"The training of a French painter-decorator of Braque’s generation involved an apprenticeship with an established master, who introduced the novice 
to the specialized branches of the trade.", 'Attributs du Peintre en Bâtiment','France','1883', 'Modern','Modern',"Cubism and the Trompe l’Oeil Tradition",'Nicolas Glaise'),
('2939',"'Attributes of the Painter-Decorator' summarizes the entire trade by depicting its essential tools and materials.",'Still Life',
'Spain','1914','Modern','Modern',"Cubism and the Trompe l’Oeil Tradition",'Pablo Picasso'),
...
('3223',"Robert Pruitt creates large-scale drawings of Black subjects within imagined narratives that draw on elements of hip-hop culture, comic books, 
science fiction, and historical Black struggles.", 'Birth and Rebirth and Rebirth','USA','2019','Modern','Modern',"Hear Me Now: The Black Potters of Old Edgefield, South Carolina",'Robert Pruitt'),
...
('4977',"The Rebellious Slave is a 2.15m high marble statue by Michelangelo, dated to 1513. It is now held in the Louvre in Paris.",'Rebel Slave',
'Italy','1513','Renaissance',"Modern",'Masterpiece of the Louvre','Michelangelo'),
('2422','The Mona Lisa is a half-length portrait painting by Italian artist Leonardo da Vinci.','Portrait of Lisa Gherardini',
'Italy','1503','Renaissance','Modern','Masterpiece of the Louvre','Leonardo Da Vinci'),
...
('2482','This is the first painting publicly exhibited by François Gérard, who became one of the foremost portraitists of the period following the 
French Revolution.','Alexandrine Émilie Brongniart','France','1784','Enlightenment','Modern','The Art of Portraiture','Jean-Louis Couasnon'),
('3362','Denis Diderot was a French philosopher, art critic, and writer, best known for serving as co-founder.','Denis Diderot',
'France','1767','Enlightenment','Modern','The Art of Portraiture','Louis-Michel van Loo'),
('2128','Charles Pierre Baudelaire was a French poet who also produced notable work as an essayist and art critic.','Self-Portrait',
'France','1860','Victorian','Modern',"The Art of Portraiture",'Charles Baudelaire');
...
INSERT INTO SCULPTURE (AId_no, Height, Weight, Material)
VALUES
('1851','101','141','Bronze'),
...
INSERT INTO PAINTING (AId_no, Paint_Type, Drawn_On)
VALUES
('2286','Oil','Canvas'),
('1350','Oil','Panel'),
...
INSERT INTO OTHER (AId_no, O_Type)
VALUES
('2934','Kitchenware'),
('1457','Metalwork'),
('1448','Collage'),
...
INSERT INTO COLLECTION (CName, Typ, Descript, Address, Phone, Contact_Person)
VALUES
...
CREATE TABLE BORROWED (
	...
	Brrw_CName					varchar(100)	not null,

	primary key (AId_no),
    foreign key (AId_no) references ART_OBJECT(Id_no),
    foreign key (Brrw_CName) references COLLECTION(CName) 
);
INSERT INTO BORROWED (AId_no, Date_borrowed, Date_returned, Brrw_CName)
VALUES
...
INSERT INTO PERMANENT_COLLECTION (AId_no, Stat, Cost, Date_acquired)
VALUES
